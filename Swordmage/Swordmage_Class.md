[Index](https://fairo20.github.io/dnd_index.html)
...
The key conviction of a Swordmage is to defend allies against those who may do them harm, and they understand how to channel the arcane energy within the world to ward against enemy advances. As a bonus action, you may mark an enemy within 15ft with your Swordmage Aegis. While marked, subtract 1d4 from attack rolls targetting allies other than you. When you mark an enemy with this feature, any other existing marks end. 

### Level 2: Aegis Defender
As your familiarity with your Aegis expands, so too does your ability to channel it in unique ways. Select one of the following paths upon reaching level 2 in this class.
...
- **Aegis of Shielding** - When the marked target damages an ally within 60ft, you can use your reaction to give them resistance to that damage.
...
Swordmages are masters of weaving spell and blade, turning the momentum of one into power of the other. When you cast a spell, your weapon attacks are made at advantage during your next turn. When you hit with an attack, the first spell you cast during your next turn may be cast as if it were one level higher than the spell slot expended. 
